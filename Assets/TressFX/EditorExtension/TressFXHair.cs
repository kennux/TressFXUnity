...
public class TressFXHair : ScriptableObject
{
	...
	[SerializeField]
	[HideInInspector]
	protected int m_NumTotalHairVertices;
	...
	[SerializeField]
	[HideInInspector]
	protected int m_NumTotalHairStrands;
	...
	[SerializeField]
	[HideInInspector]
	protected int m_MaxNumOfVerticesInStrand;
	...
	[SerializeField]
	[HideInInspector]
	protected int m_NumGuideHairVertices;
	...
	[SerializeField]
	[HideInInspector]
	protected int m_NumGuideHairStrands;
	...
	[SerializeField]
	[HideInInspector]
	protected int m_NumFollowHairsPerOneGuideHair;
	...
	[SerializeField]
	[HideInInspector]
	protected int[] m_pHairStrandType;
	...
	[SerializeField]
	[HideInInspector]
	protected Vector4[] m_pRefVectors;
	...
	[SerializeField]
	[HideInInspector]
	protected Vector4[] m_pGlobalRotations;
	...
	[SerializeField]
	[HideInInspector]
	protected Vector4[] m_pLocalRotations;
	...
	[SerializeField]
	[HideInInspector]
	protected TressFXStrandVertex[] m_pTriangleVertices;
	...
	[SerializeField]
	[HideInInspector]
	protected float[] m_pThicknessCoeffs;
	...
	[SerializeField]
	[HideInInspector]
	protected Vector4[] m_pFollowRootOffset;
	...
	[SerializeField]
	[HideInInspector]
	protected float[] m_pRestLengths;
	...
	[SerializeField]
	[HideInInspector]
	protected TressFXBoundingSphere m_bSphere;
	...
	[SerializeField]
	[HideInInspector]
	protected int[] m_TriangleIndices;
	...
	public void OpenHairData(string path)
	{
		...
		this.m_pHairStrandType = TressFXLoader.ReadIntegerArray (reader, this.m_NumTotalHairVertices);
		...
		// We are ready!
		Debug.Log ("Hair loaded. Vertices loaded: " + this.m_NumTotalHairVertices + ", Strands: " + this.m_NumTotalHairStrands);
	}
